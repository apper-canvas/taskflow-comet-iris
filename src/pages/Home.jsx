          ...
          >
            {[
              ...
              >
                ...
                <div className="text-2xl sm:text-3xl font-bold text-surface-900 dark:text-white mb-1 sm:mb-2">
                  {stat.value}
                </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-lg font-semibold text-surface-900 dark:text-white">TaskFlow</span>
          </div>
