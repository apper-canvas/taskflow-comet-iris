  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-50 via-white to-primary-50 dark:from-surface-900 dark:via-surface-800 dark:to-surface-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-4 py-2 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white rounded-xl font-medium transition-all duration-300"
            >
              Today
            </motion.button>
          </div>
        ...
        >
          <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-4">Priority Legend</h3>
            ...
            >
              ...
              <div className="space-y-6">
                {selectedTask.description && (
                  <div>
                    <h4 className="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Description</h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Due Date</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Project</h4>
                    <div className="flex items-center gap-2 text-surface-600 dark:text-surface-400">
                ...
                {selectedTask.tags.length > 0 && (
                  <div>
                    <h4 className="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Tags</h4>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-surface-200 dark:border-surface-700 mt-6">
                <Link
                  to="/"
                  className="flex-1 sm:flex-none bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 text-center"
                  onClick={closeTaskModal}
                >
                  Edit Task
                </Link>
